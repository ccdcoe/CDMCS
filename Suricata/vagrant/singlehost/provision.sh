...
# versions
ELA="elasticsearch-oss-6.6.0.deb"
KIBANA="kibana-oss-6.6.0-amd64.deb"
LOGSTASH="logstash-oss-6.6.0.deb"
...
DOCKER_ELA="docker.elastic.co/elasticsearch/elasticsearch-oss:6.6.0"
DOCKER_KIBANA="docker.elastic.co/kibana/kibana-oss:6.6.0"
DOCKER_LOGSTASH="docker.elastic.co/logstash/logstash-oss:6.6.0"
